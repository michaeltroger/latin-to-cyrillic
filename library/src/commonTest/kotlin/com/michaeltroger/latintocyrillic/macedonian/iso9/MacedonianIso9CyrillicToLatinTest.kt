...
internal class MacedonianIso9CyrillicToLatinTest {
    ...
    @Test
    fun testAlphabet() = runTest { // verified with: https://www.translitteration.com/transliteration/en/macedonian/iso-9/
            assertEquals(""""
A a
B b
V v
...
"""
    ...
    @Test
    fun testAlphabetFromTransliteration() = runTest { // verified with: https://www.translitteration.com/transliteration/en/macedonian/iso-9/
            assertEquals(""""
