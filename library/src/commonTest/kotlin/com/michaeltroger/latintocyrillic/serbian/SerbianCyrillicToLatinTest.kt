...
Наредни меч Денвер игра у Орланду 3. новембра."""))
    ...
    @Test
    fun testAlphabetFromWiki() = runTest { // source: https://hr.wikipedia.org/wiki/%C4%86irilica verified with https://transliteration.eki.ee and microsoft transliteration tool and https://www.loc.gov/catdir/cpso/roman.html
            assertEquals(""""
A, a
B, b
V, v
